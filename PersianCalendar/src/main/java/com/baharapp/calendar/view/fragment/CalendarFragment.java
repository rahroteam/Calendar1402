package com.baharapp.calendar.view.fragment;
...
import com.baharapp.calendar.Constants;
import com.baharapp.calendar.R;
import com.baharapp.calendar.adapter.CalendarAdapter;
import com.baharapp.calendar.util.Utils;
import com.baharapp.calendar.view.activity.CalendarTool;
import com.baharapp.calendar.view.dialog.SelectDayDialog;
...
public class CalendarFragment extends Fragment
    ...
    private Utils utils;
    private NestedScrollView flayout;
    ...
    public View onCreateView(
        ...
        kos = new CalendarTool();
        flayout =  view.findViewById(R.id.about_layout);
        ...
        switch (kos.getIranianMonth()) {

            case 1:
            case 2:
            case 3:

                flayout.setBackgroundResource(R.drawable.spring);
                break;
            case 4:
            case 5:
            case 6:

                flayout.setBackgroundResource(R.drawable.summer);
                break;
            case 7:
            case 8:
            case 9:
